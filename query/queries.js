...
db.restaurants.find(
{ "name": { $regex: /^Wil/ } },  {"restaurant_id":1, "name":1, "borough":1, "cuisine":1, "_id":0})
...
db.restaurants.find({$or: [{ "cuisine": "Seafood","cuisine": { $nin: ["American", "Chinese"] }},{ "name": /^Wil/ } ]},{ "name": 1, "cuisine": 1, "_id": 0 } )

// 22. Trobar restaurant_id, name, i grades per grau "A", score 11, i data "2014-08-11T00:00:00Z".
db.restaurants.find(
{$or:[{ $and: [{ "cuisine": "Seafood" },{ "cuisine": { $nin: ["American", "Chinese"] } }]},{ "name": /^Wil/ }]},{ "name": 1, "cuisine": 1, "_id": 0 })
...
db.restaurants.find({ "name": /mon/i },{"name": 1,"borough": 1,"location.coordinates": 1,"cuisine": 1,"_id": 0})  
